{
  ...
  imports = [(inputs.import-tree ./plugins)];
  ...
  services.minecraft-servers.servers.cinema = {
    ...
    package = pkgs.purpurServers.purpur-1_21_1.overrideAttrs (_old: {
    ...
    files = {
      "bukkit.yml".value = {
        ...
        ticks-per = {
          ...
          water-underground-creature-spawns = 0;
          axolotl-spawns = 0;
          ambient-spawns = 0;
        };
      };
      ...
      "spigot.yml".value = {
        ...
        world-settings.default.item-despawn-rate = 3000;
        settings.moved-wrongly-threshold = 10;
      };
